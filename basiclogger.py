...
class LOGGING:
    def __init__(self, log_name=LOG_NAME, log_level=LOG_LEVEL, log_dir="logs", show_console=False):
        ...
        # 将LOG文件按照每天分成不同的文件
        file_handler = logging.handlers.TimedRotatingFileHandler(log_file, 'midnight', interval=1, backupCount=10, encoding="UTF-8")
